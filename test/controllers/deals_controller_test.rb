...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { brand: @deal.brand, cta: @deal.cta, deal: @deal.deal, description: @deal.description, product: @deal.product } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { brand: @deal.brand, cta: @deal.cta, deal: @deal.deal, description: @deal.description, product: @deal.product } }
